...
function levelTimer() {
    if (extraTimer.innerHTML < 50) {
        extraTimer.innerHTML++
        setTimeout(() => levelTimer(), 10)
    } else if (extraTimer.innerHTML < 80) {
        extraTimer.innerHTML++
        setTimeout(() => levelTimer(), 100)
    } else if (extraTimer.innerHTML < 95) {
        extraTimer.innerHTML++
        setTimeout(() => levelTimer(), 300);
    } else if (extraTimer.innerHTML < 100) {
        extraTimer.innerHTML++
        setTimeout(() => levelTimer(), 600);
    }
}
levelTimer()
